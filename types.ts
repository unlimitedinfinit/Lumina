...
export interface LevelConfig {
  ...
  obstacleTypes?: ('static' | 'blackhole' | 'pulsar' | 'debris' | 'cube' | 'pyramid')[];
...
export type AnomalyType = 'repulsor' | 'blackhole' | 'wormhole' | 'prism' | 'time_dilation' | 'void' | 'hazard' | 'magnetic' | 'pulse' | 'warp' | 'glitch' | 'comet' | 'quasar' | 'nebula' | 'gamma';
...
export interface SandboxSettings {
  ...
  hyperTrails: boolean;
  trailStyle: 'default' | 'neon' | 'rainbow' | 'dark';
}
